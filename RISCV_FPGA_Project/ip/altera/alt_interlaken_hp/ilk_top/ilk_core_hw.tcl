...
# set_fileset_property testbench TOP_LEVEL ilk_core
...
set_parameter_property NUM_LANES DESCRIPTION "Supports 12- and 24-lane configurations. Additional lane and data rate configurations are available. Contact your Altera sales representative or email interlaken@altera.com for more information."
...
set_parameter_property ECC_ENABLE DESCRIPTION "Enables built-in ECC support on the M20K embedded block memory for single-error correction, double-adjacent-error errors correction, and triple-adjacent-error detection."
...
# for verilog files
set synth_med_level_dir { "../components" "../ilk_100g_mac" "../ilk_oob/ilk_oob_rx" "../ilk_oob/ilk_oob_tx"  "../ilk_regroup"  "../ilk_striper/top" "../ilk_striper/12lane" "../ilk_striper/20lane" "../ilk_striper/24lane"  }
...
set sim_synopsys_dir {"../components/synopsys" "../ilk_regroup/synopsys" "../ilk_100g_mac/synopsys" "../ilk_oob/ilk_oob_rx/synopsys" "../ilk_oob/ilk_oob_tx/synopsys" "../ilk_striper/top/synopsys" "../ilk_striper/12lane/synopsys" "../ilk_striper/20lane/synopsys" "../ilk_striper/24lane/synopsys"  }
...
set sim_cadence_dir {"../components/cadence" "../ilk_regroup/cadence" "../ilk_100g_mac/cadence" "../ilk_oob/ilk_oob_rx/cadence" "../ilk_oob/ilk_oob_tx/cadence"  "../ilk_striper/top/cadence" "../ilk_striper/12lane/cadence" "../ilk_striper/20lane/cadence" "../ilk_striper/24lane/cadence"  }
...
set sim_mentor_dir {"../components/mentor" "../ilk_regroup/mentor" "../ilk_100g_mac/mentor" "../ilk_oob/ilk_oob_rx/mentor" "../ilk_oob/ilk_oob_tx/mentor"  "../ilk_striper/top/mentor" "../ilk_striper/12lane/mentor" "../ilk_striper/20lane/mentor" "../ilk_striper/24lane/mentor" }
 ...
 ##### generate example testbench in simulation callback
   ...
   ## set metalen_tb [get_parameter_value METALEN]
    ...
    add_fileset_file "../testbench/ilk_pkt_checker.sv" SYSTEM_VERILOG PATH  "../testbench/example_design_100g/ilk_pkt_checker.sv" 
	 ...
	 if {$dev_family == "Arria 10" } {
	      add_fileset_file "../testbench/example_design.sv" SYSTEM_VERILOG PATH  "../testbench/example_design_100g_a10/example_design.sv" 
