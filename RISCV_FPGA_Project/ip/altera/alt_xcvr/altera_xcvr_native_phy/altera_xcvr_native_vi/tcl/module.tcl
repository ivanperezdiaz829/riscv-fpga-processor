...
package provide altera_xcvr_native_vi::module 13.1
...
namespace eval ::altera_xcvr_native_vi::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_native_a10 13.1.1  {"Arria VI" "Arria 10"}   true      false       false     ::altera_xcvr_native_vi::module::elaborate  ::altera_xcvr_native_vi::parameters::upgrade      "Arria 10 Transceiver Native PHY"   "Interface Protocols/Transceiver PHY" "Altera Corporation"  NOVAL       NOVAL         "Arria 10 Transceiver Native PHY." }\
  }
}
