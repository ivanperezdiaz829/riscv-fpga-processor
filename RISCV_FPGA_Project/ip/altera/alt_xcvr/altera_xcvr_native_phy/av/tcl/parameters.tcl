...
package provide altera_xcvr_native_av::parameters 13.1
...
namespace eval ::altera_xcvr_native_av::parameters:: {
  ...
  set parameters {\
    ...
    \
    {std_rx_rmfifo_enable                   false   true          INTEGER   0                               NOVAL                                                        l_enable_rx_std                        l_enable_rx_std             boolean       NOVAL         "Rate Match FIFO"                         "Enable RX rate match FIFO"                             ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_enable                "Enables the RX rate match FIFO in the 'Standard PCS'."}\
...
proc ::altera_xcvr_native_av::parameters::validate_std_rx_rmfifo_enable {std_rx_rmfifo_enable l_enable_rx_std std_protocol_hint std_pcs_pma_width std_rx_word_aligner_mode std_low_latency_bypass_enable} {
