...
package provide altera_xcvr_native_cv::module 13.1
...
namespace eval ::altera_xcvr_native_cv::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_native_cv  13.1  true      false       false     ::altera_xcvr_native_cv::module::elaborate  ::altera_xcvr_native_cv::parameters::upgrade  "Cyclone V Transceiver Native PHY"  "Interface Protocols/Transceiver PHY" "Altera Corporation"  NOVAL       "http://www.altera.com/literature/ug/xcvr_user_guide.pdf" "Cyclone V Transceiver Native PHY."}\
  }
}
