...
package provide altera_xcvr_native_sv::module 13.1
...
namespace eval ::altera_xcvr_native_sv::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_native_sv  13.1  true      false       false     ::altera_xcvr_native_sv::module::elaborate  ::altera_xcvr_native_sv::parameters::upgrade  "Stratix V Transceiver Native PHY"  "Interface Protocols/Transceiver PHY" "Altera Corporation"  NOVAL       "http://www.altera.com/literature/ug/xcvr_user_guide.pdf" "Stratix V Transceiver Native PHY." }\
  }
}
