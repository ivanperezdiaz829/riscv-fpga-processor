...
namespace eval ::altera_xcvr_pll_sv::module:: {
  ...
  variable module {\
    ...
    {altera_xcvr_pll_sv  13.1  true      false       false     ::altera_xcvr_pll_sv::module::elaborate  "Stratix V Transceiver PLL"  "Interface Protocols/Transceiver PHY" "Altera Corporation"  NOVAL       "http://www.altera.com/literature/ug/xcvr_user_guide.pdf" }\
  }
}
