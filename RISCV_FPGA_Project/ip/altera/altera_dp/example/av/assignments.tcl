...
set_global_assignment -name TOP_LEVEL_ENTITY av_dp_example

# add files to the project
set_global_assignment -name VERILOG_FILE av_dp_example.v
set_global_assignment -name QIP_FILE av_dp.qip
...
set_global_assignment -name SDC_FILE av_dp_example.sdc
