...
# Regenerate the IP 
qexec "qmegawiz -silent av_video_pll.v"
qexec "qmegawiz -silent av_xcvr_pll.v"
qexec "qmegawiz -silent av_aux_buffer.v"
qexec "qmegawiz -silent av_xcvr_reconfig.v"

# Regenerate the Qsys system
qexec "ip-generate --project-directory=./  \
--output-directory=./av_control/synthesis/ \
--file-set=QUARTUS_SYNTH \
--report-file=sopcinfo:./av_control.sopcinfo \
--report-file=html:./av_control.html \
--report-file=qip:./av_control/synthesis/av_control.qip \
--component-file=./av_control.qsys"

# Create the project overwriting any previous settings files
project_new av_dp_demo -overwrite
...
qexec "quartus_sta -t ./av_control/synthesis/submodules/av_control_ddr_p0_pin_assignments.tcl av_dp_demo"

# re-open the project and do a full compile
project_open av_dp_demo
