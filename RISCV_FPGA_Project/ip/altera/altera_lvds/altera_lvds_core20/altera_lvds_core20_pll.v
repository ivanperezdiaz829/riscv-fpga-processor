...
wire [8:0]      outclock_wire;

assign fclk = outclock_wire[0];
assign loaden = outclock_wire[1];
assign coreclock = outclock_wire[2];
assign tx_outclock = outclock_wire [3]; 
...
defparam altera_lvds_core20_iopll.silicon_rev = silicon_rev;
