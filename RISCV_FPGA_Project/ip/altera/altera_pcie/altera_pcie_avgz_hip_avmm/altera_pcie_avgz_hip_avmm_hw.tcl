...
set_module_property DESCRIPTION "Avalon-MM Arria V GZ Hard IP for PCI Express"
...
set_module_property DISPLAY_NAME "Avalon-MM Arria V GZ Hard IP for PCI Express"
...
proc proc_sim_vhdl {name} {
  ...
  foreach vf $verilog_file_common_rtl {
      ...
      add_fileset_file  altpcie_sv_hip_avmm_hwtcl.v        VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_avmm/mentor/altpcie_sv_hip_avmm_hwtcl.v"                                                        {MENTOR_SPECIFIC}
      add_fileset_file altpcie_sv_hip_ast_hwtcl.v            VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_ast/mentor/altpcie_sv_hip_ast_hwtcl.v"                               {MENTOR_SPECIFIC}
      add_fileset_file altpcie_hip_256_pipen1b.v             VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_ast/mentor/altpcie_hip_256_pipen1b.v"                                {MENTOR_SPECIFIC}
      add_fileset_file altpcie_rs_hip.v                      VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_ast/mentor/altpcie_rs_hip.v"                                         {MENTOR_SPECIFIC}
      add_fileset_file altpcie_rs_serdes.v                   VERILOG_ENCRYPT PATH "../altera_pcie_sv_hip_ast/mentor/altpcie_rs_serdes.v"                                      {MENTOR_SPECIFIC}
      add_fileset_file altpcierd_hip_rs.v                    VERILOG_ENCRYPT PATH "../altera_pcie_hip_ast_ed/mentor/example_design/verilog/chaining_dma/altpcierd_hip_rs.v"   {MENTOR_SPECIFIC}
