...
array set lvdsio_port_list {
   ...
   rx_locked               {rx_locked                 Input    1}
   rx_reset_ref_clk        {rx_reset_ref_clk          Output   1}
   rx_channel_data_align   {rx_channel_data_align     Output   1}
   rx_cda_reset            {rx_cda_reset              Output   1}
   tbi_tx_d_muxed          {tbi_tx_d_muxed            Output   10}
   reset_lvds              {reset_lvds            Output   1}
}
