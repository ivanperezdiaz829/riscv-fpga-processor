...
proc build_interfaces {} {
   ...
   build_phy_timestamp_interface $PCS_PHASE_MEASURE_CLK $RX_LATENCY_ADJ $TX_LATENCY_ADJ $WA_BOUNDARY
}
...
proc build_phy_timestamp_interface {args} {
   ...
   if {$enable_timestamping} {
      ...
      add_interface_port terminate_lat_adj_unused rx_latency_adj export Output 22
      add_interface_port terminate_lat_adj_unused tx_latency_adj export Output 22
