...
set_module_property DISPLAY_NAME "Hard Processor System"
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE false
set_module_property HIDE_FROM_SOPC true
add_documentation_link "HPS User Guide for Cyclone V" "http://www.altera.com/literature/hb/cyclone-v/cv_5v4_08.pdf"
add_documentation_link "HPS User Guide for Arria V"   "http://www.altera.com/literature/hb/arria-v/av_5v4_08.pdf"
...
add_display_item "" "Peripheral Pin Multiplexing"    "group" "tab"                        
...
set_parameter_property   GP_Enable   display_name   "Enable MPU general purpose signals"
set_parameter_property   GP_Enable   description    "Enables elaboration of interface mpu_gp."
...
set_parameter_property   BSEL         allowed_ranges {"1:FPGA" "2:NAND Flash (1.8v)" "3:NAND Flash (3.0v)" "4:SD/MMC External Transceiver (1.8v)" "5:SD/MMC Internal Transceiver (3.0v)" "6:QSPI Flash (1.8v)" "7:QSPI Flash (3.0v)"}
...
proc add_peripheral_pin_muxing_parameters {} {
    set TOP_LEVEL_GROUP_NAME "Peripheral Pin Multiplexing"    
                                                                     
    add_display_item $TOP_LEVEL_GROUP_NAME "help_text" "text" {<html>
	Hover the mouse cursor over the mode parameters for a tooltip regarding signal membership details.</html>
    }
	...
	foreach peripheral_name [peripherals_in_group $group_name] {
	    ...
	    set_parameter_property        $pin_muxing_param_name  display_name     "${peripheral_name} pin multiplexing"
...
proc add_gpio_parameters {} {
  ...
  #  set_parameter_property  GPIO_Enable group $table_name
   ...
   # set_parameter_property  LOANIO_Name_DERIVED group $table_name
...
proc add_clock_parameters {} {
    set TOP_LEVEL_GROUP_NAME "HPS Clocks"                     
                                                             
    set group_name "User Clocks"
    add_display_item $TOP_LEVEL_GROUP_NAME $group_name "group" "" 

    add_parameter           S2FCLK_USER0CLK_Enable boolean false ""
    set_parameter_property  S2FCLK_USER0CLK_Enable display_name "Enable HPS-to-FPGA user 0 clock"
    set_parameter_property  S2FCLK_USER0CLK_Enable group $group_name

    add_parameter           S2FCLK_USER0CLK_FREQ integer 100 ""
    set_parameter_property  S2FCLK_USER0CLK_FREQ display_name "User 0 clock frequency"
    set_parameter_property  S2FCLK_USER0CLK_FREQ group $group_name
    set_parameter_property  S2FCLK_USER0CLK_FREQ units Megahertz
    set_parameter_property  S2FCLK_USER0CLK_FREQ allowedRanges {1:1000}
    
    add_parameter           S2FCLK_USER1CLK_Enable boolean false ""
    set_parameter_property  S2FCLK_USER1CLK_Enable display_name "Enable HPS-to-FPGA user 1 clock"
    set_parameter_property  S2FCLK_USER1CLK_Enable group $group_name

    add_parameter           S2FCLK_USER1CLK_FREQ integer 100 ""
    set_parameter_property  S2FCLK_USER1CLK_FREQ display_name "User 1 clock frequency"
    set_parameter_property  S2FCLK_USER1CLK_FREQ group $group_name
    set_parameter_property  S2FCLK_USER1CLK_FREQ units Megahertz
    set_parameter_property  S2FCLK_USER1CLK_FREQ allowedRanges {1:1000}
    
    add_parameter           S2FCLK_USER2CLK_Enable boolean false ""
    set_parameter_property  S2FCLK_USER2CLK_Enable display_name "Enable HPS-to-FPGA user 2 clock"
    set_parameter_property  S2FCLK_USER2CLK_Enable group $group_name

    add_parameter           S2FCLK_USER2CLK_FREQ integer 100 ""
    set_parameter_property  S2FCLK_USER2CLK_FREQ display_name "User 2 clock frequency"
    set_parameter_property  S2FCLK_USER2CLK_FREQ group $group_name
    set_parameter_property  S2FCLK_USER2CLK_FREQ units Megahertz
    set_parameter_property  S2FCLK_USER2CLK_FREQ allowedRanges {1:1000}

    set group_name "PLL Reference Clocks"
    add_display_item $TOP_LEVEL_GROUP_NAME $group_name "group" ""

    add_parameter           F2SCLK_PERIPHCLK_Enable boolean false ""
    set_parameter_property  F2SCLK_PERIPHCLK_Enable display_name "Enable FPGA-to-HPS peripheral PLL reference clock"
    set_parameter_property  F2SCLK_PERIPHCLK_Enable group $group_name

    set parameter "F2SCLK_PERIPHCLK_FREQ"
    add_parameter          $parameter integer 100 ""
    set_parameter_property $parameter display_name  "peripheral pll reference clock clock frequency"
    set_parameter_property $parameter system_info_type "CLOCK_RATE"
    set_parameter_property $parameter system_info_arg f2h_periph_ref_clock
    set_parameter_property $parameter visible false
    set_parameter_property $parameter group $group_name
    
    add_parameter           F2SCLK_SDRAMCLK_Enable boolean false ""
    set_parameter_property  F2SCLK_SDRAMCLK_Enable display_name "Enable FPGA-to-HPS SDRAM PLL reference clock"
    set_parameter_property  F2SCLK_SDRAMCLK_Enable group $group_name

    set parameter "F2SCLK_SDRAMCLK_FREQ"
    add_parameter          $parameter integer 100 ""
    set_parameter_property $parameter display_name  "sdram pll reference clock clock frequency"
    set_parameter_property $parameter system_info_type "CLOCK_RATE"
    set_parameter_property $parameter system_info_arg f2h_sdram_ref_clock
    set_parameter_property $parameter visible false
    set_parameter_property $parameter group $group_name
...
proc logicalview_dtg {} {
    ...
    source ../device_tree_generation/hps_periphs.tcl
    ...
    if { $f2h_present } {
        ...
        hps_utils_add_slave_interface bridges.axi_f2h timer2.axi_slave0 {0xffd00000}
        hps_utils_add_slave_interface bridges.axi_f2h timer3.axi_slave0 {0xffd01000}
        ...
        hps_utils_add_slave_interface bridges.axi_f2h spi0.axi_slave0 {0xffe02000}
        hps_utils_add_slave_interface bridges.axi_f2h spi1.axi_slave0 {0xffe03000}
    ...
    hps_instantiate_uart0 $number_of_a9
    
    hps_instantiate_uart1 $number_of_a9
    ...
    hps_instantiate_i2c0 $number_of_a9
    
    hps_instantiate_i2c1 $number_of_a9
    
    hps_instantiate_i2c2 $number_of_a9
    
    hps_instantiate_i2c3 $number_of_a9
    
    hps_instantiate_nand0 $number_of_a9
    
    hps_instantiate_spi0 $number_of_a9
    
    hps_instantiate_spi1 $number_of_a9
    
    hps_instantiate_qspi $number_of_a9
    
    hps_instantiate_sdmmc $number_of_a9
    
    hps_instantiate_usb0 $number_of_a9
    
    hps_instantiate_usb1 $number_of_a9
    
    hps_instantiate_gmac0 $number_of_a9
    
    hps_instantiate_gmac1 $number_of_a9
...
#####################################################
	...
	set new_mode_option [lindex $new_valid_modes 0]
    } else {
...
proc elab {logical_view} {
    ...
    set emac0_fpga_enabled [expr {[string compare $emac0_pin_mux_value [FPGA_MUX_VALUE]] == 0 && [lsearch $emac0_pin_mux_allowed_ranges [FPGA_MUX_VALUE]] != -1}]
    set emac1_fpga_enabled [expr {[string compare $emac1_pin_mux_value [FPGA_MUX_VALUE]] == 0 && [lsearch $emac1_pin_mux_allowed_ranges [FPGA_MUX_VALUE]] != -1}]
    
    if {$emac0_fpga_enabled || $emac1_fpga_enabled } {
...
proc elab_TPIUFPGA {device_family} {
	...
	# TODO: associate with h2f_tpiu_clock?
	...
	# TODO: test that this is dependent on clock driving ..clk_in
...
proc elab_GP {device_family} {
	...
	set instance_name mpu_gp
	set atom_name hps_interface_mpu_general_purpose
	set location [locations::get_fpga_location $instance_name $atom_name]
	
	set iface_name "h2f_mpu_gp"
	set z          "h2f_mpu_gp_"
	fpga_interfaces::add_interface       $iface_name  conduit Input
...
proc elab_clocks_resets {device_family} {
	...
	set frequency [get_parameter_value S2FCLK_USER2CLK_FREQ]
	set frequency [expr {$frequency * [MHZ_TO_HZ]}]
...
proc ensure_pin_muxing_data {device_family} {
 ...
 #  }
    ...
    if {!$load_rc} {                           
	send_message error "The pin multiplexing information for the Hard Processor System could not be determined. Please check whether your edition of Quartus II supports the selected device."
	return          
    }              
