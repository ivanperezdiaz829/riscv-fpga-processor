...
set_module_assignment embeddedsw.dts.compatible {altr,socfpga-stmmac snps,dwmac-3.70a snps,dwmac}
set_module_assignment embeddedsw.dts.group ethernet
set_module_assignment embeddedsw.dts.params.mac-address {[00 00 00 00 00 00]}
