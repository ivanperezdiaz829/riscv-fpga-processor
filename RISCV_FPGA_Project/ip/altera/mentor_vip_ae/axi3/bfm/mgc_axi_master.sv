...
interface mgc_axi_master #(int AXI_ADDRESS_WIDTH = 64, int AXI_RDATA_WIDTH = 1024, int AXI_WDATA_WIDTH = 1024, int AXI_ID_WIDTH = 18, int index = 0)
(
    input  ACLK,
    input  ARESETn,
    output AWVALID,
        ...
        fork
          ...
          begin
            ...
            begin
              ...
              begin
                repeat(trans.data_ready_delay[index] - last_read_data_valid_ready_active_delay_count - 1) wait_on(AXI_CLOCK_POSEDGE);
              end
        ...
        fork
          ...
          begin
            ...
            begin
              ...
              begin
                repeat(trans.write_response_ready_delay - last_write_resp_valid_ready_active_delay_count - 1) wait_on(AXI_CLOCK_POSEDGE);
              end
