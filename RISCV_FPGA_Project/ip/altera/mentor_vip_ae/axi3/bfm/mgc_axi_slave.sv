...
interface mgc_axi_slave #(int AXI_ADDRESS_WIDTH = 64, int AXI_RDATA_WIDTH = 1024, int AXI_WDATA_WIDTH = 1024, int AXI_ID_WIDTH = 18, int index = 0)
(
    input  ACLK,
    input  ARESETn,
    input  AWVALID,
      ...
      fork
        ...
        begin
          ...
          begin
            ...
            if (trans.delay_mode == AXI_VALID2READY)
            begin
              repeat(trans.address_ready_delay - 1) wait_on(AXI_CLOCK_POSEDGE);
            end
            else
            begin
              repeat(trans.address_ready_delay - last_read_addr_valid_ready_active_delay_count - 1) wait_on(AXI_CLOCK_POSEDGE);
            end
      ...
      fork
        ...
        begin
          ...
          begin
            ...
            begin
              repeat(trans.address_ready_delay - last_write_addr_valid_ready_active_delay_count - 1) wait_on(AXI_CLOCK_POSEDGE);
            end
          ...
          begin
            ...
            begin
              ...
              if (trans.delay_mode == AXI_VALID2READY)
                ...
                repeat(trans.data_ready_delay[index] - last_write_data_valid_ready_active_delay_count - 1) wait_on(AXI_CLOCK_POSEDGE);
