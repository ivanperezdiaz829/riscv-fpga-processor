# Cyclone IV Constraint file.

# PCI_CF_Device_Family = Cyclone IV 
...
proc sanity_checks { speed device core  } {
        ...
        # Check if customer is targeting on Cyclone IV device
	set device_family_name "Cyclone IV GX"
...
proc pci_pin_asgn {device full_64 master core pin_list no_pins got_prefix got_suffix prefix suffix use_dedicated_clk } {
        ...
        # Container constraints for Cyclone IV
...
puts "Info: You have sourced the Cyclone IV GX PCI constraint file."
