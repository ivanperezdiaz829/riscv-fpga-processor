...
proc sanity_checks { speed device core  } {
	...
	set device_name [get_part_info -device $device]
	...
	if { $device_speed == "7" && $speed == "66" && ($device_name == "EP3CLS150" || $device_name == "EP3CLS200" ) } {
                puts "Error: Altera does not support 66 MHz PCI in Cyclone III LS -7 device speed grades for $device_name"
                puts "       Change the device speed grade in your project"
                error ""
        }
