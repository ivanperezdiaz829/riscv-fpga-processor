...
# $Id: //acds/rel/13.1/ip/sld/st/altera_streaming_sld_hub_controller/altera_streaming_sld_hub_controller_hw.tcl#3 $
# $Revision: #3 $
# $Date: 2013/10/16 $
# $Author: aferrucc $
...
proc compose {} {
  ...
  if {$manual} {
    ...
    set_interface_assignment sink debug.providesServices sldHub
