...
# $Id: //acds/rel/13.1/ip/sopc/components/verification/altera_nios2_custom_instr_slave_bfm/altera_nios2_custom_instr_slave_bfm_hw.tcl#2 $
# $Revision: #2 $
# $Date: 2013/08/15 $
# $Author: saafnan $
#------------------------------------------------------------------------------
...
set_module_property DISPLAY_NAME                   "Altera Nios II Custom Instruction Slave BFM"
