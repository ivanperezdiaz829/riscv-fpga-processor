...
set_module_property NAME alt_vip_cl_broadcast_dil
set_module_property DISPLAY_NAME "Broadcast Deinterlacer"
set_module_property DESCRIPTION "The Broadcast Deinterlacer II combines Sobel-based quality with video-over-film capability."
...
add_bits_per_symbol_parameters 8 10

add_is_422_parameters
set_parameter_property   IS_422                      ALLOWED_RANGES            1:1
...
set_parameter_property    SYMBOLS_IN_PAR    ALLOWED_RANGES         2:2
...
# isBroadcast pre-selects highest quality
set isBroadcast 1
...
#NB effectively unused :
add_parameter MOTION_BPS int 6
...
set_parameter_property   CADENCE_DETECTION          ALLOWED_RANGES           1:1
set_parameter_property   CADENCE_ALGORITHM_NAME     ALLOWED_RANGES          {CADENCE_32_22}
...
proc dil2_validation_callback {} {
   ...
   set max_motion_line_word_size    [expr ($max_width + $motion_samples_per_word - 1) / $motion_samples_per_word]
...
proc dil2_composition_callback_instantiation {} {
   ...
   # Motion values plus VOF are stored in memory - 32 bits per pixel:
   ...
   set_instance_parameter_value   motion_writer                 NUMBER_OF_COLOR_PLANES       4
   ...
   set_instance_parameter_value   motion_reader                 NUMBER_OF_COLOR_PLANES       4
   ...
   set_instance_parameter_value   dil_algo_input_mux            DATA_WIDTH                   $video_data_width
...
proc dil2_composition_callback_connections {} {
   ...
   add_connection            video_in_duplicator.av_st_dout_1            dil_algo_input_mux.av_st_din_0   
  #add_connection            video_in_duplicator.av_st_dout_1            edi_line_buffer.av_st_din   
   ...
   add_connection            video_in_duplicator.av_st_dout_3            motion_detect.av_st_field3  
   ...
   # 13.0 I don't believe this is ever used??? Remove :
   ...
   add_connection            motion_detect.resp                  scheduler.resp3 
